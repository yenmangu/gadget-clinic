...
echo "label.repair-type {width: 300px; height: 50px; position: relative}";
echo "label.repair-type::before {content: ''; position: absolute; right: -25px; bottom: 0; width: 0; height: 0; border-left: 25px solid #c70039; border-top: 25px solid transparent; }";
echo "label.repair-type::after {content: ''; position: absolute; left: 0; bottom: 0; width: 0; height: 0; border-left: 25px solid white; border-top: 25px solid transparent; border-bottom: 25px solid transparent; }";
echo "span.price-span {position: relative; top: 14px; left: 20px; color: white;}";
echo "span.cost-span {position: relative; top: 14PX; left: 12px color: white;}";
