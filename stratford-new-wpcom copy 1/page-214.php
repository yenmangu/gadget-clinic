    ...
    <main id="main" class="site-main">
        ...
        <div class="main-content" id="repair-main">
            <div class="deviceName" ">
                ...
                Services and Repairs for <?= $devices['deviceName'] ?><br>

                </h4>
                <img class="service-image-from-sql" src="<?= $devices['image-url'] ?>" alt=""></img>
                ...
                <div class="repairOption">
                    ...
                    <div class="screenRepair repairOption">
                        ...
                        <img class="style-svg" src="/wp-content/uploads/2022/07/icons8-broken-phone-64.png"
                            alt="broken-phone-image">
                    ...
                    <div class="waterDamage repairOption">
                        ...
                        <img class="style-svg" src="/wp-content/uploads/2022/07/icons8-water-64.png"
                            alt="broken-phone-image">
                    ...
                    <div class="batteryReplacement repairOption">
                        ...
                        <img class="style-svg" src="/wp-content/uploads/2022/07/icons8-empty-battery-64.png"
                            alt="broken-phone-image">

                    </div>
                </div>
            </div>
            <div class="side-container repair-side-container">
